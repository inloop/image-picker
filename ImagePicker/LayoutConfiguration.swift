...
extension LayoutConfiguration {
    var hasAnyAction: Bool { return showsFirstActionItem || showsSecondActionItem }
    var sectionIndexForActions: Int { return 0 }
    var sectionIndexForCamera: Int { return 1 }
    var sectionIndexForAssets: Int { return 2 }
