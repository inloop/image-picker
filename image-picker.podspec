#
#  Be sure to run `pod spec lint image-picker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "INLOOPX"
  # s.authors            = { "INLOOPX" => "info@inloopx.com" }
  # s.social_media_url   = "http://twitter.com/INLOOPX"
  ...
  s.source       = { :git => "https://github.com/inloop/image-picker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", "ImagePicker/**/*.{h,m,swift,xib,storyboard}"
  ...
  # s.resource  = "icon.png"
  s.resources = "ImagePicker/Assets.xcassets"
